...
function Match() {
  ...
  const columns = [
    ...
    { field: 'conpensation_type', headerName: 'Conpensation', width: 120 },
  ...
  useEffect(() => {
    ...
    const statisticData = matchData.map((job,index) => { return { 
          ...
          conpensation_type: job.conpensation_type,  
